...
// - 클래스를 기반으로 생성, 클래스의 인스턴스라고 불림, 클래스에 할당되어 있음
...
// fields
// 클래스의 속성을 정의하는 '변수'
// : 명명규칙 - 전에 수업함. 카멜 케이스(첫 글자 소문자, 연결 키워드 시작 대문자)
...
// public : 외부의 어떤 파일 또는 내부의 어느 위치에서든 해당 클래스에 접근 가능
...
//		: 해당 클래스 내에서만 접근 가능
		class Car {
			...
			int maxSpeed; // 최대 속력
			double weight; // 중량
			boolean isElectric; // 전기자동차 인지에 대한 여부
		}
