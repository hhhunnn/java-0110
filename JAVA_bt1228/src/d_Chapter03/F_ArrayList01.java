...
//		자바의 기본 배열 형태
//		: 한 번 생성되면 크기를 변경 X
//		: 변경하려면 새로운 배열을 생성하고, 원래 배열의 요소를 복사
...
//		: 배열의 타입 지정 시, 일반 데이터 타입이 아닌 참조 타입으로 작성 - 대문자로 표기
//		: int(Integer), char(Charactor), boolean(Boolean), String 등
//		
//		ArrayList 생성
//		ArrayList<데이터타입> 배열명 = new ArrayList<>(크기 지정 -선택);
		ArrayList<Integer> arrayList = new ArrayList<>();
		
//		ArrayList 데이터 추가
//		: 해당 리스트(배열)의 가장 끝에 값을 추가 - 기존의 배열이 있을 경우
//		배열명.add(추가할데이터);
		arrayList.add(1); // 인덱스 0 - 처음부터 추가됨(기존의 배열이 없음)
