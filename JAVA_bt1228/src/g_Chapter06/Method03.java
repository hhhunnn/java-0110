...
class MyMath {
	...
	void add2(int a, int b) {System.out.println(a+b);} 
	...
	// : 반환값의 유무에 관계없이 모든 메서드에는 적어도 하나 이상의 return문이 존재해야 함
...
public class Method03 {
	public static void main(String[] args) {
		...
		// 		, 호출된 메서드(main)로 돌아와 return 이후 문장을 실행
		//		, 반환된 값을 value 변수에 할당
...
//		int value5 = mm.add2(10, 20); // Error
		mm.add2(10, 20); // 출력O
		System.out.println(value1);
		System.out.println(value2);
		System.out.println(value3);
		System.out.println(value4);
//		System.out.println(mm.add2(10, 20));
	}
}