...
// Game 클래스
// 한 명의 사용자가 게임을 진행 할 때 마다 점수가 쌓이는 로직 (= 능력치)
...
class Game {
	...
	// 새로운 게임이 생성되면 전체 인스턴스에서 공유되는 numberOfGames 정적 변수를 1씩 증가
	Game() {
		numberOfGames++;
	}
	...
	// 게임 점수를 증가시키는 메서드
	// int score : 지역 변수 
	// : addScore 메서드가 호출 될 때 마다 다른 값을 가지며 해당 메서드 내에서만 사용 가능
...
public class Object03 {
	public static void main(String[] args) {
		...
		Game game3 = new Game(); // 세 번째 게임
		Game game4 = new Game(); // 네 번째 게임
		Game game5 = new Game(); // 다섯 번째 게임
		Game game6 = new Game(); // 여섯 번째 게임
		Game game7 = new Game(); // 일곱 번째 게임
