...
// - break 문으로 종료 시점을 결정
// - : break 가 있는 case 에서 switch 종료

// - default 문으로 해당하는 case 가 없을 때 실행할 구문을 작성
...
//		case 값 : 비교할 대상의 값과 일치하는 값
		...
		System.out.println("Chapter을 입력하세요.");
